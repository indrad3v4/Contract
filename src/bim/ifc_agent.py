...
class IFCAgent:
    ...
    def __init__(self):
        ...
        # Check dependencies
        self.deps_available = IFCOPENSHELL_AVAILABLE and OPENAI_AVAILABLE and OPENAI_AGENTS_AVAILABLE
    ...
    def _get_building_info_tool(self):
        ...
        def get_building_info() -> Dict[str, Any]:
            ...
            return {
                ...
                "building_name": building.Name if building and building.Name else "Unknown Building",
    ...
    def _get_system_prompt(self) -> str:
        ...
        """
        return """
        You are an expert BIM (Building Information Modeling) assistant specialized in analyzing IFC (Industry Foundation Classes) files. 
        ...
        - get_building_info: Provides basic information about the building like name, number of storeys, etc.
        ...
        Use these tools to answer queries about the building. First, determine which tools are needed to answer the user's question.
        Always provide specific, data-driven responses based on the actual IFC model content. Avoid making assumptions about
        ...
        When responding, organize information clearly with appropriate formatting. If the data reveals issues or opportunities
