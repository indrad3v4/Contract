...
class IFCParser:
    ...
    def _element_to_dict(self, element: Any) -> Dict:
        ...
        element_name = element.Name if hasattr(element, "Name") and element.Name else f"{element_type}_{element.id()}"
                ...
                for definition in element.IsDefinedBy:
                    if definition.is_a("IfcRelDefinesByProperties"):
                        ...
                        if property_set.is_a("IfcPropertySet"):
                            pset_name = property_set.Name if property_set.Name else "Unknown"
                ...
                for association in element.HasAssociations:
                    if association.is_a("IfcRelAssociatesMaterial"):
                        ...
                        if relating_material.is_a("IfcMaterial"):
                            ...
                            layer_names = [layer.Material.Name for layer in material_set.MaterialLayers]
    ...
    def _get_property_value(self, nominal_value: Any) -> Any:
        ...
        if value_type == "IfcInteger" or value_type == "IfcReal":
            ...
            return str(nominal_value.wrappedValue) if hasattr(nominal_value, "wrappedValue") else str(nominal_value)