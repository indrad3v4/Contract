...
def proto_to_amino(msg):
    ...
    return {"type": amino_type, "value": amino_value}
...
def amino_to_proto(msg):
    ...
    return {"typeUrl": type_url, "value": proto_value}
...
class TestMessageFormatConversion:
    ...
    def test_round_trip_conversion(self):
        ...
        assert (
            converted_proto["value"]["fromAddress"]
            == original_proto["value"]["fromAddress"]
        )
        assert (
            converted_proto["value"]["toAddress"]
            == original_proto["value"]["toAddress"]
        )
