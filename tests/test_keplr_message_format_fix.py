...
class TestKeplrMessageFormatFix:
    ...
    def test_conversion_from_incorrect_to_amino_format(self):
        ...
        assert converted["value"]["from_address"] == "odiseo1nse3slfxqmmu4m5dlyczsee52rpnr53c3rt705"
        assert converted["value"]["to_address"] == "odiseo1qg5ega6dykkxc307y25pecuv380qje7zp9qpxt"
    ...
    def test_amino_to_proto_conversion(self):
        ...
        assert proto_msg["value"]["fromAddress"] == "odiseo1nse3slfxqmmu4m5dlyczsee52rpnr53c3rt705"
        assert proto_msg["value"]["toAddress"] == "odiseo1qg5ega6dykkxc307y25pecuv380qje7zp9qpxt"
