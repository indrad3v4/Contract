...
class TestEndToEndFlow:
    ...
    def test_simplified_flow(self, mock_transaction_service, mock_multisig_gateway, 
                            mock_keplr_signature, mock_broadcast_response,
                            sample_bim_file):
        ...
        broadcast_result = mock_transaction_service.broadcast_transaction(signature_data)
    ...
    def test_message_format_conversion(self):
        ...
        assert converted_proto['value']['fromAddress'] == proto_msg['value']['fromAddress']
